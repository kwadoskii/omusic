...
export const SmallCard = ({}) => {
  return (
    <div className="flex flex-col cursor-pointer gap-1 opacity-80 hover:opacity-100 transition-all ease-in duration-300 hover:scale-[1.02]first:pl-2 last:pr-2 w-40">
