...
export default function TopCarts({}) {
  ...
  return (
    <div
      className="rounded-2xl p-4 px-5 bg-[#1A1E1F] my-4 cursor-pointer hover:shadow-md hover:scale-[1.02] hover:shadow-white/5 duration-[350] transition-all ease-in"
      onClick={() => push("/chart")}
    >
      <div className="flex items-center">
        <div className="flex flex-col md:flex-row flex-1 gap-4">
          ...
          <div className="flex flex-col justify-evenly text-white font-thin">
            ...
            <p className="text-sm mt-5 md:mt-0">2:34:45</p>
          </div>
        </div>

        <div className="flex items-center justify-center self-start md:self-center">
